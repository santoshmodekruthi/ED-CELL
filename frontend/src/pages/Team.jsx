...
const teamData = [
  ...
  {
    section: "TECHNICAL MEMBERS",
    members: [
      { name: "Bharath", role: "Technical Member", image: "/team/Bharath.jpg.jpeg", objectPosition: "center", objectFit: "object-contain bg-white" },
      { name: "M. Harsha Vardhan", role: "Technical Member", image: "/team/harsha.jpg.jpeg" },
      { name: "G. Prathima", role: "Technical Member", image: "/team/G.prathima.jpg.jpeg" }
    ],
    layout: "trio"
  },
  {
    section: "SOCIAL MEDIA MEMBERS",
    members: [
      ...
      { name: "B. Thanmai Sri", role: "Social Media Member", image: "/team/B.Thanmai sri.jpeg" },
      { name: "A. Akshaya", role: "Social Media Member", image: "/team/A.Akshaya.jpeg" },
      { name: "P. Rushitha", role: "Social Media Member", image: "/team/P. Rushitha.jpg.jpeg" },
      { name: "P. Hari Sagar", role: "Social Media Member", image: "/team/P. Hari Sagar.jpg.jpeg" },
      { name: "G. Grishma", role: "Social Media Member", image: "/team/G.grishma.jpg.jpeg", objectPosition: "center 20%", objectFit: "object-cover" }
    ],
    layout: "trio"
  },
  {
    ...
    members: [
      ...
      { name: "K. Neha Sri", role: "Designing", image: "/team/K.neha sri.jpg.jpeg", objectPosition: "center", objectFit: "object-contain bg-white" }
    ],
    layout: "duo"
  },
  {
            ...
            {teamData.map((group, sectionIndex) => (
              ...
              >
                ...
                <div className={`grid gap-8 w-full ${
                  ...
                  group.layout === 'single' ? 'max-w-sm mx-auto grid-cols-1' :
